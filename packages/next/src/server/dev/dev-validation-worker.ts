...
// The worker and the app-page runtime are separate module graphs in one realm.
// Register one stateless API that both graphs can find. Per-validation active
// span and collector state remains scoped by AsyncLocalStorage.
